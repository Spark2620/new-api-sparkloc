...
var SupportedChannelTypes = map[int]bool{
	ChannelTypeOpenAI:     true,
	ChannelTypeAnthropic:  true,
	ChannelTypeAws:        true,
	ChannelTypeGemini:     true,
	ChannelTypeAzure:      true,
	ChannelTypeVertexAi:   true,
	ChannelTypeXai:        true,
	ChannelTypeCustom:     true,
	ChannelTypeCodex:      true,
	ChannelTypeVolcEngine: true,
}

var SupportedChannelTypeIDs = []int{
	ChannelTypeOpenAI,
...
func IsSupportedChannelType(channelType int) bool {
	return SupportedChannelTypes[channelType]
}
